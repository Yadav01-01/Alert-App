...
object AppConstant {
    ...
    const val RememberMe_SESSION:String="rememberMe_session"
    const val Id: String ="ID"
    const val NAME: String ="NAME"
    const val EMAIL :String ="Email"
    const val profilePic :String ="userImg"
    const val UserEditable :String ="UserEditable"
    const val tokenUser :String ="token"
